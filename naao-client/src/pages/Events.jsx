...
const events = [
	{
		...
		organizers: [
			"Mr. Ashabhanu Swain - Head Coordinator - President, NAAO",
			"Mr. Saroj Bag - Head Coordinator - Secretary, NAAO",
			"Mr. Sitaram Beria - Head Coordinator - Treasurer, NAAO",
			"Mr. Gyana Mallick - Venue Coordinator",
			"Mr. Anshuman Dehuri - Venue Coordinator",

			"Mr. Tapan Jena - Food Coordinator",
			"Miss Shobharani Bhanja - Guest Coordinator",
			"Mr Sanjay Nayak - Guest Coordinator",
			...
			"Mr. Rudra Narayan Satapathy - Fund Coordinator",
			"Mr. Manoj Pattanayak - Cultural Coordinator",
			"Mrs. Sarita Rath - Cultural Coordinator",
			"Mrs. Lipika Das - Cultural Coordinator",
		],
